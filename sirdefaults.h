...
static const sir_level_style_map sir_default_styles[] = {
    {SIRL_DEBUG, SIRS_BLACK | SIRS_DIM},
    {SIRL_INFO, SIRS_WHITE},
    {SIRL_NOTICE, SIRS_CYAN},
    {SIRL_WARN, SIRS_YELLOW | SIRS_BRIGHT},
    {SIRL_ERROR, SIRS_RED},
    {SIRL_CRIT, SIRS_RED | SIRS_BRIGHT},
    {SIRL_ALERT, SIRS_RED | SIRS_BRIGHT},
    {SIRL_EMERG, SIRS_RED | SIRS_BRIGHT},
    {0, 0}
};
