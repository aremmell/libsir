...
#define SWIGTYPE_p_sirinit swig_types[1]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__sir

#else
#  define SWIG_init    init_sir

#endif
#define SWIG_name    "_sir"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_sir_init(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  sirinit *arg1 = (sirinit *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  bool result;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_sirinit, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "sir_init" "', argument " "1"" of type '" "sirinit *""'"); 
  }
  arg1 = (sirinit *)(argp1);
  result = (bool)sir_init(arg1);
...
static PyMethodDef SwigMethods[] = {
	 { "sir_init", _wrap_sir_init, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_sirinit = {"_p_sirinit", "sirinit *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_sirinit[] = {  {&_swigt__p_sirinit, 0, 0, 0},{0, 0, 0, 0}};
