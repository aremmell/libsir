 ...
 * generated by \a strftime.
 * 
 * Example output from the default: Fri 27 Apr 18 @ 15:36:45
 */
#define SIR_FHTIMEFORMAT "%a %d %b %y @ %H:%M:%S (%Z)"
...
#define validlevels(levels) \
    ((levels & SIRL_ALL) != 0 && (levels & SIRO_MSGONLY) == 0)

#define validopts(opts) \
    ((opts & SIRL_ALL) == 0 && opts <= 0x8000)
