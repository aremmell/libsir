...
|----------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------|
| **`CC`**                                | Command to execute the compiler for code compilation and linking                                                                                  | System specific; usually **`cc`**                            |
| **`CFLAGS`**                            | Flags passed to the compiler when compiling                                                                                                       | System specific; usually unset                               |
...
| **`SIR_SHARED`**                        | Flags passed to the compiler when linking a shared library                                                                                        | `-qmkshrobj` *for IBM XL C/C++ for AIX,* `-shared` otherwise |
